...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <form class="form-inline searchForm" id="searchForm" action="{{route('admin.attachment.index')}}" method="GET">
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header">
                    <div>
                        <a title="添加" data-toggle="tooltip" class="btn btn-primary btn-sm " href="{{route('admin.attachment.add')}}">
                        ...
                        <a class="btn btn-danger btn-sm AjaxButton" data-toggle="tooltip" title="删除选中数据"
                           ...
                           data-url="{{route('admin.attachment.del')}}">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="td-do">
                                <a href="{{route('admin.attachment.edit',['id'=>$item['id']])}}"
