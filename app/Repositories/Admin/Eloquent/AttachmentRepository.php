...
use App\Http\Model\Common\Banner;
...
class AttachmentRepository implements AttachmentInterface
{
    ...
    {
        $query = Attachment::addWhere($param);
    ...
    {
        return Attachment::create($param);
    }
    ...
    public function destroy($id)
    {
        ...
        $noDeletionId = (new Attachment())->getNoDeletionId();
