...
class CreateSettingGroupTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('setting_group', function (Blueprint $table) {
            ...
            $table->string('module', 30)->collation('utf8mb4_general_ci')->default('')->comment('作用模块');
            $table->string('name', 50)->collation('utf8mb4_general_ci')->default('')->comment('名称');
            $table->string('description', 100)->collation('utf8mb4_general_ci')->default('')->comment('描述');
            $table->string('code', 50)->collation('utf8mb4_general_ci')->default('')->comment('代码');
