...
class CreateUserLevelTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_level', function (Blueprint $table) {
            ...
            $table->string('name', 20)->collation('utf8mb4_general_ci')->default('')->comment('名称');
            $table->string('description', 50)->collation('utf8mb4_general_ci')->default('')->comment('简介');
            $table->string('img', 255)->collation('utf8mb4_general_ci')->default('/static/index/images/user_level_default.png')->comment('图片');
